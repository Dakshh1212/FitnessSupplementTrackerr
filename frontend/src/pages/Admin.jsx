...
export default function Admin() {
  ...
  const fetchData = async () => {
    try {
      ...
      setUserChart(chartRes.data.data.users);
      setWorkoutChart(chartRes.data.data.workouts);
  ...
  const pieData = stats ? [
    ...
    { name: "Diet", value: stats.diets },
    { name: "Supplements", value: stats.supplements }
  ] : [];
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {stats && Object.entries(stats).map(([k, v], i) => (
              <div key={i} className="bg-white/5 border border-white/10 backdrop-blur-xl rounded-2xl p-5">
                <p className="text-gray-400 capitalize text-sm">{k}</p>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-5">
              <h2 className="mb-3">User Growth</h2>
          ...
          <div className="space-y-3">
            ...
            {filtered.map((u) => (
              <div
                ...
                className="flex justify-between items-center bg-white/5 border border-white/10 rounded-2xl p-4 cursor-pointer hover:bg-white/10"
              >
                <div>
